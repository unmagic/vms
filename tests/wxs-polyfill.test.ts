...
`
  ...
  describe('字符串方法 polyfill 模板集成', () => {
    it('模板中使用 .padStart()', async () => {
      const vueContent = `
<template>
...
`
  ...
  describe('typeof 运算符模板集成', () => {
    it('模板中使用 typeof', async () => {
      const vueContent = `
<template>
